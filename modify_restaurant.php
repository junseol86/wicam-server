<?php
    ...
    if ($unauthorized == 0) {
        ...
        $sql_modify = "UPDATE wicam.restaurant SET
                        item_name = '$restaurant_name', genre = '$genre', description = '$description', address = '$address', latitude = '$latitude', longitude = '$longitude', phone1 = '$phone1', phone2 = '$phone2',
                        school_idx = '$school_id', modifier_idx = '$user_id', modifier_nickname = '$user_nickname', modify_time = '$now'
