<?php
    ...
    if ($unauthorized == 0) {
        ...
        $sql_modify = "UPDATE wicam.delivery SET
                        item_name = '$delivery_name', menu = '$menu', delivery_condition = '$delivery_condition', description = '$description',
                        includes = '$includes', phone1 = '$phone1', phone2 = '$phone2',
